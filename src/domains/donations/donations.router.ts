...
import { kofiBodySchema, patreonBodySchema } from './donations.schema.js';
...
donationsRouter.post('/patreon', validate({ body: patreonBodySchema }), asyncHandler(controller.handlePatreon));
